...
public class SoalMenggunakanIkonPadaMsWord extends Activity {
    ...
    private static String url = "http://sinauit.000webhostapp.com/modulkuis/SoalMenggunakanIkonPadaMsWord.php";
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalMenggunakanIkonPadaMsWord.this);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalMenggunakanIkonPadaMsWord.this)
                    .create();
