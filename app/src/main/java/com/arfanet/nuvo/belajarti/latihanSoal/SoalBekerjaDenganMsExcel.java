...
public class SoalBekerjaDenganMsExcel extends Activity {
    ...
    private static String url = "http://sinauit.000webhostapp.com/modulkuis/SoalBekerjaDenganMsExcel.php";
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalBekerjaDenganMsExcel.this);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalBekerjaDenganMsExcel.this)
                    .create();
