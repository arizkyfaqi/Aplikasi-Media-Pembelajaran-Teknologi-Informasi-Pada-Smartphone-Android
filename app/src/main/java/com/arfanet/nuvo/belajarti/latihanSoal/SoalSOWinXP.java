...
public class SoalSOWinXP extends Activity {
    ...
    private static String url = "http://sinauit.000webhostapp.com/modulkuis/SoalSOWinXP.php";
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalSOWinXP.this);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalSOWinXP.this)
                    .create();
