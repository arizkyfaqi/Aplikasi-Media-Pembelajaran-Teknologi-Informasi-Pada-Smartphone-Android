...
public class SoalSejarahTIK extends Activity {
    ...
    private static String url = "http://sinauit.000webhostapp.com/modulkuis/SoalSejarahTIK.php";
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalSejarahTIK.this);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalSejarahTIK.this)
                    .create();
