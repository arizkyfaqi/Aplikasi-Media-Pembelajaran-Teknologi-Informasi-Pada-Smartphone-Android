...
public class DaftarDownload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3){
                Intent i = null;
                if (position == 0){
                    i = new Intent(DaftarDownload.this, TIK.class);}
                else if(position == 1){
                    i = new Intent(DaftarDownload.this, SejarahTIK.class);}
                else if(position == 2){
                    i = new Intent(DaftarDownload.this, PDTIK.class);}
                else if(position == 3){
                    i = new Intent(DaftarDownload.this, Hardware.class);}
                else if(position == 4){
                    i = new Intent(DaftarDownload.this, Software.class);}
                else if(position == 5){
                    i = new Intent(DaftarDownload.this, SOWinXP.class);}
                else if(position == 6){
                    i = new Intent(DaftarDownload.this, MenuIconMsword.class);}
                else if(position == 7){
                    i = new Intent(DaftarDownload.this, MenggunakanIkonPadaMsWord.class);}
                else if(position == 8){
                    i = new Intent(DaftarDownload.this, FungsiIkonMsExcel.class);}
                else if(position == 9){
                    i = new Intent(DaftarDownload.this, PenggunaanMenuIkonMsExcel.class);}
                else if(position == 10){
                    i = new Intent(DaftarDownload.this, BekerjaDenganMsExcel.class);}
                else if(position == 11){
                    finish();}
                else{}
