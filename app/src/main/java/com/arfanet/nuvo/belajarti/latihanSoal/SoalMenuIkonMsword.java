...
public class SoalMenuIkonMsword extends Activity {
    ...
    private static String url = "http://sinauit.000webhostapp.com/modulkuis/SoalMenuIkonMsword.php";
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalMenuIkonMsword.this);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalMenuIkonMsword.this)
                    .create();
